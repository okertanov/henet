...
${OBJECTDIR}/henet.o: henet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -std=gnu++0x -pthread -lpthread -lresolv -MMD -MP -MF $@.d -o ${OBJECTDIR}/henet.o henet.cpp

${OBJECTDIR}/hetest.o: hetest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -std=gnu++0x -pthread -lpthread -lresolv -MMD -MP -MF $@.d -o ${OBJECTDIR}/hetest.o hetest.cpp
